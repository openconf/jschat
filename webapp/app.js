...
require.register("JSChat/reacts/BackboneMixin.js", function(exports, require, module){
module.exports = {
  componentDidMount: function() {
  // Whenever there may be a change in the Backbone data, trigger a reconcile.
  ...
  render: function(){
    ...
    var user = function(meModel){
      if(meModel && meModel.get('id')){
        ...
        return React.DOM.li(null, 
          React.DOM.a( {className:"btn btn-default", href:window.host + "/auth/github?backUrl=" + encodeURIComponent(location.href),  target:"_self"}, "Login with GitHub")
        ) 
      }
    }
